...
import controlPanel from '../Time/controlPanel';
import transformProps from '../Time/transformProps';
import thumbnail from '../Time/images/thumbnail.png';

export default class TimeFilterV2Plugin extends ChartPlugin {
  constructor() {
    const metadata = new ChartMetadata({
      name: t('Time filter v2'),
