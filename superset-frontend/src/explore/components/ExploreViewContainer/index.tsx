...
export const getOwnStateForQuery = (
  ownState: JsonObject | undefined,
): JsonObject =>
  omit(ownState, ['clientView', 'metricSqlExpressions']) as JsonObject;
...
function mapStateToProps(state: ExploreRootState) {
  ...
  const ownStateForQuery = getOwnStateForQuery(
    dataMask[slice_id]?.ownState as JsonObject | undefined,
  );
