...
WELCOME_DASHBOARD_THUMBNAIL_CACHE_TIMEOUT = int(timedelta(days=7).total_seconds())
WELCOME_DASHBOARD_THUMBNAIL_TIMEOUT = int(timedelta(minutes=5).total_seconds())
WELCOME_DASHBOARD_THUMBNAIL_LOCK_TIMEOUT = int(timedelta(hours=6).total_seconds())
