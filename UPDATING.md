...
It tracks the current fork-only changes relative to `origin/6.0.0` and is the
main checklist to review before upgrading this fork to a newer Superset version.
